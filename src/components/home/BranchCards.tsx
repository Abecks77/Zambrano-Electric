  ...
  return (
    <section id="branches" className="py-32 bg-[#050505] relative overflow-hidden border-t border-[#1a1a1a]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              >
                <Link to={`/branch/${branch.id}`} className="block h-full">
                  <div className="relative glassmorphism p-10 border border-metal hover:border-race-red transition-all duration-500 overflow-hidden h-full flex flex-col bg-[#0A0A0A]">
                    ...
                    <div className="mt-auto pt-8 border-t border-metal/30 flex items-center justify-between">
        ...
        {/* Global Footer Hub */}
        <div className="mt-20 flex flex-wrap justify-between items-center gap-8 border-t border-metal pt-8 opacity-40 hover:opacity-100 transition-opacity">
